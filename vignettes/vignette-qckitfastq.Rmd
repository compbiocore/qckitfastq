...
The *GC_content* function computes the GC nucleotide content percentage per read. As a general rule, an indication of good data quality is when the GC content percentage is between 30 and 50%.
