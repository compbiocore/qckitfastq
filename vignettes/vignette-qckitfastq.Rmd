...
```{r}
<<<<<<< HEAD
<<<<<<< HEAD:vignettes/vignette-qckitfastq.Rmd
scA <- sequence_content(fseq, content = "A",writefile=FALSE)
=======
scA <- sequence_content(fseq, content = "A")
>>>>>>> 8b7a35974eaf430eec131d25a46bd2daad66fa61:vignettes/vignette-qckitfastq.Rmd
=======
scA <- sequence_content(fseq, content = "A",writefile=FALSE)
>>>>>>> bbc964f5e70df180af1d32612ec47e9370dd901f
scA
```
